...
namespace TouhouEnemyModels
{
    ...
    internal class Patches
    {
        ...
        public static SkinnedMeshRenderer suikaMeshRenderer;
        public static SkinnedMeshRenderer marisaMeshRenderer;
            ...
            switch (__instance)
            {
                                           ...
                                           TouhouEnemiesPlugin.EnableForestGiantReplace.Value:
                {
                    try
                    {
                        ...
                        suikaMeshRenderer = suikaMesh.GetComponent<SkinnedMeshRenderer>();
                                          ...
                                          TouhouEnemiesPlugin.EnableHoarderBugReplace.Value:
                {
                    try
                    {
                        ...
                        marisaMeshRenderer = marisaMesh.GetComponent<SkinnedMeshRenderer>();
                        ...
                        var marisaAnimator = marisaVisual.transform.Find("HoarderBugModel").GetComponent<Animator>();
                            var marisaController = marisaAnimator.runtimeAnimatorController;
                            ai.creatureAnimator = marisaAnimator;
                            ai.creatureAnimator.runtimeAnimatorController =
                                    new AnimatorOverrideController(marisaController);
                ...
                //        /* This reset the state of the animator? I have no idea. It just works. */
                //        radMechAnimator.runtimeAnimatorController =
                //            new AnimatorOverrideController(originalController);
        ...
        public static void SuikaLost(ForestGiantAI __instance)
        {
            ...
            __instance.creatureSFX.Stop();
            __instance.creatureSFX.PlayOneShot(TouhouEnemiesPlugin.DeadAudio, 0.5f);
            WalkieTalkie.TransmitOneShotAudio(__instance.creatureSFX, TouhouEnemiesPlugin.DeadAudio, 0.2f);
            suikaMeshRenderer.SetBlendShapeWeight(3, 0);
        ...
        public static void MarisaLost(HoarderBugAI __instance, ref float ___velX, ref float ___velZ)
        {
            ...
            __instance.creatureSFX.PlayOneShot(TouhouEnemiesPlugin.DeadAudio, 0.5f);
            WalkieTalkie.TransmitOneShotAudio(__instance.creatureSFX, TouhouEnemiesPlugin.DeadAudio, 0.2f);
            var component = __instance.gameObject.transform.Find("HoarderBugModel").Find("AnimContainer").gameObject.GetComponent<Animator>();
